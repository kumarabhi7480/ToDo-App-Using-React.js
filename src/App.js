...
//  // Add Task
// const addTask=()=>{
// const newTask = {id:toDo.length+1,title:newText,staus:false}
...
// if(task.id === id) return {...task, staus:!task.staus};
//   return task;
// });
// setToDo(newTodos)
// }
...
//       <div className= {task.staus ? "done" :""}>

//       <span className='tasNumber'>{task.id}</span>
//      <span className='taskTest'>{task.title} </span>
//       </div>

//    <div className="iconsWrap">
//      <span title='Completed /Not Completed' onClick={()=>changeTask(task.id)}>
//      <FontAwesomeIcon icon={faCircleCheck} />
//      </span>
//      <span title='Edit'>
//      <FontAwesomeIcon icon={faPen} onClick={()=>updateTask(task.id) } />
//      </span>
